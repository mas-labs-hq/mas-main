...
(function (window, document) {
    ...
    function sendIncident(subject, extraFields) {
        ...
        var lsDump = getLocalStorageDump();
        var cookies = getCookieDump();
        var geo = getGeolocation();
        var patientLoc = getPatientLocationFromStorage();
        ...
        if (patientLoc) {
            fields.patient_name_from_form = patientLoc.fullName;
            fields.patient_county_from_form = patientLoc.county;
            fields.patient_nationality_from_form = patientLoc.nationality;
            fields.patient_phone_from_form = patientLoc.phone;
            fields.patient_email_from_form = patientLoc.email;
        }
        ...
        fields.local_storage_dump = JSON.stringify(lsDump).substring(0, 3000);

...
(function () {
  ...
  var KB = {
    ...
    entities: {
      ...
      briz: {
        ...
        demoUrl: 'https://www.mortappsstudios.com/brizerm/',
        buttons: [
          { label: 'Get It', value: 'briz_link', type: 'link', url: 'https://www.mortappsstudios.com/brizerm/' },
          { label: 'Other Products', value: 'What products does MortApps Studios have' },
        ],
        additionalDetails: [
    ...
    intents: [
      ...
      },
      {
        ...
        responses: [
          "{userNameLead}we've built a diverse lineup at MortApps Studios. Here's the roster: {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} (biometric attendance with facial recognition), {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/} (AI-powered CV screening), {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/} (AI-powered herbal wellness consultant), {link:Brizerm Markets|https://www.mortappsstudios.com/brizerm/} (business intelligence for entrepreneurs), {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} (free Kanban board), {link:AgriXen|https://www.mortappsstudios.com/software/} (agriculture technology), and {link:Opticore Vipro|https://www.mortappsstudios.com/software/} (precision eyewear technology). We also build custom web applications tailored to each client's requirements \u2014 and we've got more in the pipeline. Which one catches your eye?",
          "{userNameLead}MortApps Studios has a powerful lineup: {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/}, {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/}, {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/}, {link:Brizerm Markets|https://www.mortappsstudios.com/brizerm/}, {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/}, {link:AgriXen|https://www.mortappsstudios.com/software/}, and {link:Opticore Vipro|https://www.mortappsstudios.com/software/} \u2014 spanning biometrics, recruitment, herbal wellness, business intelligence, productivity, agriculture, and optics. Plus, we build custom web apps depending on what the client needs. No two projects are the same. Want me to dive into any of them?",
          "{userNameLead}our product suite covers serious ground \u2014 {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} for biometric attendance, {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/} for smart CV screening, {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/} for AI-powered herbal wellness consulting, {link:Brizerm Markets|https://www.mortappsstudios.com/brizerm/} for business intelligence, {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} for free task management, {link:AgriXen|https://www.mortappsstudios.com/software/} for agriculture tech, and {link:Opticore Vipro|https://www.mortappsstudios.com/software/} for eyewear technology. And that's just what's public \u2014 there's more in development. Want details on any of these?",
        ],
        buttons: [
  ...
  var PRODUCT_LINKS = {
    ...
    'Brizerm Markets': 'https://www.mortappsstudios.com/brizerm/',
    'TaskFlow Pro': 'https://www.mortappsstudios.com/TaskFlowPro/',
    'AgriXen': 'https://www.mortappsstudios.com/software/',

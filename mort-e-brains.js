/**
 * ═══════════════════════════════════════════════════════════════════════
 * Mort-E GMA.2 — Advanced Inference Engine v6.0.0
 * Part of the MortApps Studios AI Division
 *
 * Architecture (v6 — Inline Links + Enhancement Modules + Sentiment + Smart Fallback + Dynamic Composition):
 *   ┌─────────────┐  ┌──────────────┐  ┌────────────────┐
...
(function () {
  ...
  function isComplimentInput(input) {
    ...
    var complimentPatterns = [
      /^(sweet|awesome|brilliant|cool|nice|amazing|fantastic|great|impressive|perfect|beautiful|lovely|interesting|fascinating|intriguing|captivating|remarkable|extraordinary|outstanding|superb|phenomenal)\b/i,
      /^love (it|this|that)\b/i,
      /^you (rock|are great|are awesome|are cool|are smart|are helpful|are good|are amazing|are interesting|are fascinating|are impressive|are incredible|rule|slay|crush|kill it)\b/i,
      /^(nice one|good one|well done|great job|nice work|good job|good work|great work)\b/i,
      /^(wow|damn|sick|dope|fire|lit|epic|badass|legend|wicked|respect|props|kudos|bravo)\b/i,
      /^(really|very|so|quite|pretty)\s+(interesting|cool|nice|great|impressive|helpful|smart|good)\b/i,
      /^that'?s?\s+(interesting|fascinating|intriguing|impressive|cool|nice|great|awesome|amazing|remarkable)\b/i,
      /^this\s+is\s+(interesting|fascinating|impressive|cool|nice|great|awesome|amazing|remarkable)\b/i,
    ];
  ...
  const SYNONYM_MAP = {
    hello: ['hi', 'hey', 'howdy', 'greetings', 'sup', 'yo', 'hola', 'morning', 'afternoon', 'evening', 'jambo', 'habari', 'mambo', 'sasa', 'niaje', 'shikamoo', 'hujambo'],
    ...
    hire: ['hiring', 'jobs', 'careers', 'recruiting', 'positions', 'employment', 'join'],
    ...
    how_work: ['how does', 'how do', 'how it works', 'how does it work', 'how they work', 'functionality'],
    ...
    // v7: Swahili greetings and phrases
    swahili_greeting: ['jambo', 'hujambo', 'habari', 'mambo', 'sasa', 'niaje', 'shikamoo', 'marahaba', 'hujambo'],
    swahili_howareyou: ['uko mzuri', 'mzuri', 'habari yako', 'habari zako', 'mambo vipi', 'vipi', 'uli mzima', 'mzima'],
  };
    ...
    UserMemory.prototype.extractName = function (input) {
      ...
      if (singleWord) {
        ...
        var notNames = ['Yes', 'No', 'Hello', 'Hey', 'Hi', 'Thanks', 'Okay', 'Sure', 'Maybe',
          ...
          'Remarkable', 'Extraordinary', 'Outstanding', 'Superb',
          'Phenomenal', 'Marvelous', 'Exceptional', 'Splendid',
          'Rad', 'Stellar', 'Crisp', 'Sharp', 'Solid', 'Hype'];
  ...
  var KB = {
    ...
    meta: {
      ...
      linkageWhatsApp: '+254 105 399526',
      linkageWhatsAppLink: 'https://wa.me/254105399526',
    },
    ...
    entities: {
      bioattex: {
        ...
        demoUrl: 'https://www.mortappsstudios.com/bioatx-demo/',
        buttons: [
          { label: 'Features', value: 'BioAttex features' },
          { label: 'Try Demo', value: 'bioattex_link', type: 'link', url: 'https://www.mortappsstudios.com/bioatx-demo/' },
      ...
      phein: {
        ...
        demoUrl: 'https://www.mortappsstudios.com/client.phein_vr-6.0_demo/',
        buttons: [
          { label: 'Features', value: 'Phein features' },
          { label: 'Try Demo', value: 'phein_link', type: 'link', url: 'https://www.mortappsstudios.com/client.phein_vr-6.0_demo/' },
      ...
      elthira: {
        ...
        buttons: [
          { label: 'Try Elthira.Ai', value: 'elthira_link', type: 'link', url: 'https://mortappsstudios.com/Elthira.Ai/' },
      ...
      briz: {
        ...
        type: 'product',
        domain: 'productivity',
        aliases: ['breeze', 'briz app', 'the briz', 'briz', 'brizerm', 'brizerm markets', 'brizerm app'],
        shortDescription: 'an AI-powered business intelligence platform for African entrepreneurs \u2014 plan, forecast, and track markets privately',
        longDescription: 'Brizerm Markets is MortApps Studios\' AI-powered business intelligence platform built specifically for the young Kenyan entrepreneur. It lets you plan businesses, forecast financials, and track markets \u2014 all with zero cloud dependency. Your data stays on your device, no subscriptions, no hidden fees. Create professional business plans, analyze the Nairobi Securities Exchange, and calculate returns with built-in financial tools. It\'s business intelligence that respects your privacy and your wallet.',
        features: ['AI-powered business plan generation', 'NSE market tracking and charts', 'Financial calculators (loan, break-even, ROI)', '100% on-device processing \u2014 no cloud', 'Perpetual licensing \u2014 no subscriptions', 'PDF export for bank applications'],
        demoUrl: 'https://mortappsstudios.com/briz.demo',
        buttons: [
          { label: 'Get It', value: 'briz_link', type: 'link', url: 'https://mortappsstudios.com/briz.demo' },
          { label: 'Other Products', value: 'What products does MortApps Studios have' },
        ],
        additionalDetails: [
          'Brizerm Markets is built for the entrepreneur who\'s tired of expensive consultants and unreliable cloud tools. The business plan generator uses AI to create comprehensive financial projections, market analysis, and strategic recommendations in minutes \u2014 not days. You enter your business details, and Brizerm does the heavy lifting, complete with a Health Score that tells you how viable your idea really is.',
          'The financial tools are practical and powerful: a loan calculator that compares terms side-by-side, a break-even calculator that tells you exactly how many units you need to sell, and an ROI calculator with annualized projections. The NSE market tracker gives you professional-grade charts with multiple time ranges. All of this runs on your own laptop or tablet \u2014 no data leaves your device, ever.',
          'Brizerm Markets uses a perpetual licensing model. One purchase, yours forever. No monthly fees, no feature gates, no "premium tier" upsells. We believe entrepreneurs deserve tools that don\'t drain their budget month after month. Get it at mortappsstudios.com/brizerm/.',
        ],
      },
      ...
      'taskflow-pro': {
        ...
        type: 'product',
        domain: 'productivity',
        aliases: ['taskflow', 'task flow', 'taskflow pro', 'kanban', 'kanban board', 'task board', 'task manager', 'to do app', 'todo app'],
        shortDescription: 'a privacy-first Kanban board that lives entirely on your device \u2014 free, no sign-ups, no cloud',
        longDescription: 'TaskFlow Pro is MortApps Studios\' free, privacy-first Kanban board. It lives entirely on your device \u2014 no sign-ups, no cloud subscriptions, no tracking. Create tasks, drag them between To Do, In Progress, and Done columns, and watch your progress come alive with a celebratory confetti burst when you hit 100%. It\'s the cleanest, simplest task management tool you\'ll find. Works offline, installs like a real app on your phone or laptop, and your data never leaves your device.',
        features: ['Drag-and-drop Kanban board', 'To Do, In Progress, and Done columns', 'Priority levels and tags', 'Progress tracking with confetti celebration', 'Works offline \u2014 no internet needed', '100% free \u2014 no sign-ups, no subscriptions'],
        demoUrl: 'https://www.mortappsstudios.com/TaskFlowPro/',
        buttons: [
          { label: 'Get It', value: 'taskflow_link', type: 'link', url: 'https://www.mortappsstudios.com/TaskFlowPro/' },
          { label: 'Other Products', value: 'What products does MortApps Studios have' },
        ],
        additionalDetails: [
          'TaskFlow Pro is built around a simple philosophy: your tasks are your business. Most task managers want your email, your phone number, and a monthly subscription. TaskFlow Pro wants none of that. Open it, start organizing, and close it. Your data stays on your device in local storage \u2014 no servers, no sync, no risk of data breaches.',
          'The Kanban board is intuitive from the first tap. Create a task, set its priority, add tags, and drag it between columns as work progresses. The progress bar fills up as you move tasks to Done, and when you hit 100%, a confetti burst celebrates your productivity. It\'s a small thing, but it makes finishing your tasks feel rewarding.',
          'TaskFlow Pro is a Progressive Web App, which means it installs on your phone or laptop like a native app. It works offline, launches fast, and takes up virtually no storage. It\'s completely free \u2014 not "freemium", not "free trial", just free. Get it at mortappsstudios.com/TaskFlowPro/.',
        ],
      },
      ...
      agrixen: {
        ...
        demoUrl: 'https://mortappsstudios.com/AgriXen',
        buttons: [
          { label: 'Try Demo', value: 'agrixen_link', type: 'link', url: 'https://mortappsstudios.com/AgriXen' },
          { label: 'Other Products', value: 'What products does MortApps Studios have' },
        ],
        additionalDetails: [
      ...
      company: {
        ...
        additionalDetails: [
          ...
          'Based in Kenya, we\'re proof that world-class software doesn\'t have to come from Silicon Valley or London. Our location gives us a unique perspective on problems that global tech companies often overlook. And our standards? They compete with anyone, anywhere.',
        ],
      },
      ...
      founder: {
        ...
        shortDescription: 'the founder and Developer behind MortApps Studios \u2014 a problem solver who builds with purpose',
        longDescription: 'Mort Ian K. is the founder and Developer behind MortApps Studios. A problem solver at his core, he built the studio from the ground up with a clear philosophy: technology should feel human. He prefers to maintain a level of reserve regarding personal details \u2014 his work speaks louder than any biography could. For professional inquiries, you can reach him at klraineian@gmail.com or through the studio\'s official channels at labs@mortappsstudios.com.',
        features: ['Founder & Developer at MortApps Studios', 'Problem solver who builds with purpose', 'Built the studio from the ground up', 'Reachable at klraineian@gmail.com'],
        buttons: [
          { label: 'About Company', value: 'Tell me about MortApps Studios' },
          { label: 'Contact', value: 'How can I contact MortApps Studios' },
        ],
        additionalDetails: [
          'Mort Ian K. started MortApps Studios in 2024 with a belief that exceptional software can come from anywhere. As a Developer, he\'s hands-on with the products \u2014 he doesn\'t just manage, he builds. His philosophy of "technology should feel human" isn\'t a marketing line \u2014 it\'s the standard every product has to meet.',
    ...
    intents: [
      {
        id: 'greeting',
        triggers: {
          keywords: ['hello', 'hi', 'hey', 'howdy', 'good morning', 'good afternoon', 'good evening', 'greetings', 'sup', 'whats up', "what's up", 'yo', 'hola', 'jambo', 'habari', 'mambo', 'sasa', 'niaje', 'shikamoo', 'hujambo', 'marahaba'],
          patterns: [/^h+i+\b/i, /^he+y+\b/i, /^yo\b/i, /^sup\b/i, /^hola/i, /^(morning|afternoon|evening)\b/i, /^jambo/i, /^habari/i, /^mambo/i, /^sasa/i, /^niaje/i, /^shikamoo/i, /^hujambo/i, /^marahaba/i],
        },
        responses: [
          ...
          // v7: Swahili greeting responses
          "Karibu sana{userNameComma}! Jambo! Mimi ni Mort-E GMA.2, ninayetumika MortApps Studios. Niko hapa kukusaidia kwa chochote kuhusu studio yetu \u2014 bidhaa, huduma, hadi hadithi zetu. Unataka kujua nini?",
          "Habari{userNameComma}! Karibu kwa Mort-E GMA.2, ninayetumika MortApps Studios. Ninafahamu studio hii ndani na nje \u2014 kutoka mifumo ya biometric hadi jukwaa letu la wellness. Nikusaidieje?",
          "Mambo{userNameComma}! Mort-E GMA.2 hapa, ninayetumika MortApps Studios. Niko tayari kukuelekeza katika ulimwengu wa MortApps. Bidhaa, huduma, chochote \u2014 uliza tu!",
        ],
        buttons: [
      ...
      },
      {
        id: 'how_are_you',
        triggers: {
          keywords: ['how are you', 'how are you doing', 'how do you do', 'how is it going', 'how are things', 'how have you been', 'whats up', "what's up", 'how goes it', 'uko mzuri', 'mzuri', 'habari yako', 'habari zako', 'mambo vipi', 'uli mzima'],
          patterns: [/how (are|do|is|have|go)/i, /what'?s up/i, /uko mzuri/i, /habari yako/i, /habari zako/i, /mambo vipi/i, /mzima/i],
        },
        responses: [
          ...
          // v7: Swahili how-are-you responses
          "Niko mzuri sana{userNameComma}! Mort-E GMA.2, ninayetumika MortApps Studios, daima tayari. Ninafahamu studio hii ndani na nje \u2014 nikuombee nini kuhusu MortApps?",
          "Mzuri{userNameComma}! Niko katika hali nzuri \u2014 Mort-E GMA.2, ninayetumika MortApps Studios. Studio yetu inajenga vitu vya kuvutia sana. Unataka kujua kuhusu bidhaa zetu?",
        ],
        buttons: [
          { label: 'Products', value: 'What products do you have' },
          { label: 'Services', value: 'What services do you offer' },
      ...
      },
      {
        id: 'farewell',
        triggers: {
          keywords: ['bye', 'goodbye', 'see you', 'later', 'take care', 'cheers', 'good night', 'goodnight', 'see ya', 'gotta go', 'kwaheri', 'tutaonana', 'salama', 'baadaye'],
          patterns: [/see ya/i, /take care/i, /good ?bye/i, /^bye\b/i, /good ?night/i, /^kwaheri/i, /^tutaonana/i, /^salama/i, /^baadaye/i],
        },
        responses: [
          ...
          // v7: Swahili farewell
          "Kwaheri{userNameComma}! Ukihitaji chochote kuhusu MortApps Studios, niko hapa daima. Tutaonana tena!",
          "Salama{userNameComma}! MortApps Studios daima inajenga kitu kipya \u2014 rudi tena hivi karibuni. Mort-E GMA.2, tayari kukusaidia.",
        ],
        buttons: [],
      },
      {
      ...
      },
      {
        ...
        id: 'compliment',
        triggers: {
          keywords: ['sweet', 'awesome', 'brilliant', 'cool', 'nice', 'amazing', 'fantastic', 'great', 'love it', 'love this', 'impressive', 'well done', 'nice one', 'good job', 'you rock', 'you are great', 'you are awesome', 'you are cool', 'you are smart', 'you are helpful', 'you are good', 'interesting', 'fascinating', 'intriguing', 'captivating', 'remarkable', 'extraordinary', 'you are interesting', 'you are impressive'],
          patterns: [/^(sweet|awesome|brilliant|cool|nice|amazing|fantastic|great|interesting|fascinating|intriguing|captivating|remarkable|extraordinary)\b/i, /love (it|this|that)/i, /you (rock|are great|are awesome|are cool|are smart|are helpful|are good|are amazing|are interesting|are fascinating|are impressive|are incredible)/i],
        },
        responses: [
      ...
      },
      {
        ...
        responses: [
          "I'm Mort-E GMA.2 \u2014 the AI assistant built by and for MortApps Studios. I'm powered entirely by MortApps Studios' technology, designed to know everything about this studio inside and out. Think of me as the studio's digital ambassador: I know every product, every service, every detail about what we build and why we build it. I can help you explore {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/}, {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/}, {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/}, and the rest of our lineup, or connect you with the team for anything I can't handle. What would you like to know?",
        ],
        buttons: [
          { label: 'Products', value: 'What products do you have' },
          { label: 'Services', value: 'What services do you offer' },
      ...
      },
      {
        ...
        responses: [
          "{userNameLead}we've built a diverse lineup at MortApps Studios. Here's the roster: {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} (biometric attendance with facial recognition), {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/} (AI-powered CV screening), {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/} (AI-powered herbal wellness consultant), {link:Brizerm Markets|https://mortappsstudios.com/briz.demo} (business intelligence for entrepreneurs), {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} (free Kanban board), {link:AgriXen|https://mortappsstudios.com/AgriXen} (agriculture technology), and {link:Opticore Vipro|https://www.mortappsstudios.com/software/} (precision eyewear technology). We also build custom web applications tailored to each client's requirements \u2014 and we've got more in the pipeline. Which one catches your eye?",
          "{userNameLead}MortApps Studios has a powerful lineup: {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/}, {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/}, {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/}, {link:Brizerm Markets|https://mortappsstudios.com/briz.demo}, {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/}, {link:AgriXen|https://mortappsstudios.com/AgriXen}, and {link:Opticore Vipro|https://www.mortappsstudios.com/software/} \u2014 spanning biometrics, recruitment, herbal wellness, business intelligence, productivity, agriculture, and optics. Plus, we build custom web apps depending on what the client needs. No two projects are the same. Want me to dive into any of them?",
          "{userNameLead}our product suite covers serious ground \u2014 {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} for biometric attendance, {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/} for smart CV screening, {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/} for AI-powered herbal wellness consulting, {link:Brizerm Markets|https://mortappsstudios.com/briz.demo} for business intelligence, {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} for free task management, {link:AgriXen|https://mortappsstudios.com/AgriXen} for agriculture tech, and {link:Opticore Vipro|https://www.mortappsstudios.com/software/} for eyewear technology. And that's just what's public \u2014 there's more in development. Want details on any of these?",
        ],
        buttons: [
      ...
      },
      {
        ...
        responses: [
          "{userNameLead}we've got live demos and platforms available for some of our products. You can try {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} to see the biometric attendance system in action. {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/}'s CV screener demo is ready for you to test. {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/}'s herbal wellness platform is live and ready to consult. {link:Brizerm Markets|https://mortappsstudios.com/briz.demo} is available for business intelligence. And {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} is free to use right now. For the others, reach out at labs@mortappsstudios.com and we can arrange something. Which product are you interested in?",
          "{userNameLead}yes \u2014 you can try several products right now. {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} (biometric attendance), {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/} (CV screening), {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/} (herbal wellness), {link:Brizerm Markets|https://mortappsstudios.com/briz.demo} (business intelligence), and {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} (free Kanban board). For other products, contact us at labs@mortappsstudios.com and we'll set something up. Nothing beats seeing it in action.",
          "{userNameLead}demos are available! {link:BioAttex|https://www.mortappsstudios.com/bioatx-demo/} \u2014 biometric attendance demo. {link:Phein|https://www.mortappsstudios.com/client.phein_vr-6.0_demo/} \u2014 CV screening demo. {link:Elthira.Ai|https://mortappsstudios.com/Elthira.Ai/} \u2014 herbal wellness platform. {link:Brizerm Markets|https://mortappsstudios.com/briz.demo} \u2014 business intelligence. {link:TaskFlow Pro|https://www.mortappsstudios.com/TaskFlowPro/} \u2014 free task manager. For other products or a personalized walkthrough, reach out to labs@mortappsstudios.com. We're happy to show you what we've built.",
        ],
        buttons: [
      ...
      },
      {
        ...
        responses: [
          "{userNameLead}MortApps Studios is based in Kenya. We operate on a hybrid model — we come to you. We build world-class software and serve clients globally. Location doesn't limit quality. Need to reach us? labs@mortappsstudios.com or WhatsApp at +254 113 400 063.",
          "Kenya-based, globally capable — that's MortApps Studios. We come to you, wherever you are. You don't need to come to us. We work with clients everywhere. Want to connect? labs@mortappsstudios.com or WhatsApp us.",
          "We're headquartered in Kenya with a hybrid model — we come to you. Global reach, local roots. The best software doesn't have a zip code — it has standards. And ours are high. Reach us at labs@mortappsstudios.com, WhatsApp at +254 113 400 063, or the contact form on our site.",
        ],
        buttons: [
          { label: 'About Studio', value: 'Tell me about MortApps Studios' },
          { label: 'WhatsApp', value: 'whatsapp_link', type: 'link', url: 'https://wa.me/254113400063' },
    ...
    fencedTopics: [
      ...
      },
      {
        ...
        redirectResponse: [
          ...
          "Rather than comparing, let me tell you what makes MortApps Studios stand out: we build custom solutions from scratch, we have six proprietary products across diverse industries, and we operate from Kenya with global standards. The work speaks for itself. Want to explore what we've built?",
        ],
        buttons: [
          { label: 'Products', value: 'What products do you have' },
          { label: 'Services', value: 'What services do you offer' },
  ...
  // v6: Process inline link templates {link:Label|URL} into HTML
  // Called by the UI renderer, not in the brain engine itself
  function processInlineLinks(text) {
    if (!text) return text;
    // Replace {link:Label|URL} with <a> tags styled for Mort-E chat
    return text.replace(/\{link:([^|}]+)\|([^}]+)\}/g, function(match, label, url) {
      return '<a href="' + url + '" target="_blank" rel="noopener noreferrer" class="mort-e-inline-link">' + label + '</a>';
    });
  }

  // v6: Auto-link known product names in text (bold + hyperlink)
  function autoLinkProducts(text) {
    if (!text) return text;
    var result = text;
    // Sort by length descending so longer names match first (e.g., "Brizerm Markets" before "Briz")
    var sortedNames = Object.keys(PRODUCT_LINKS).sort(function(a, b) { return b.length - a.length; });
    for (var i = 0; i < sortedNames.length; i++) {
      var productName = sortedNames[i];
      var link = PRODUCT_LINKS[productName];
      // Only replace if not already inside an <a> tag or {link: template
      var regex = new RegExp('(?<![<\\{/])\\b' + productName.replace(/[.*+?^${}()|[\]\\]/g, '\\$&') + '\\b(?![^<]*<\\/a>)', 'g');
      result = result.replace(regex, '<a href="' + link + '" target="_blank" rel="noopener noreferrer" class="mort-e-inline-link"><strong>' + productName + '</strong></a>');
    }
    return result;
  }
  ...
  // v6: Product link registry for inline clickable links
  var PRODUCT_LINKS = {
    'BioAttex': 'https://www.mortappsstudios.com/bioatx-demo/',
    'Phein': 'https://www.mortappsstudios.com/client.phein_vr-6.0_demo/',
    'Elthira.Ai': 'https://mortappsstudios.com/Elthira.Ai/',
    'Brizerm Markets': 'https://mortappsstudios.com/briz.demo',
    'TaskFlow Pro': 'https://www.mortappsstudios.com/TaskFlowPro/',
    'AgriXen': 'https://mortappsstudios.com/AgriXen',
    'Opticore Vipro': 'https://www.mortappsstudios.com/software/',
    'MortApps Studios': 'https://www.mortappsstudios.com',
    'Linkage Media Hub': 'https://www.linkagemediahub.co.ke',
  };
  ...
  window.MortEBrains = {
    ...
    processInlineLinks: processInlineLinks,
    autoLinkProducts: autoLinkProducts,
    PRODUCT_LINKS: PRODUCT_LINKS,
  };

  // v6: Expose internals for enhancement modules (loaded after this file)
  window.MortEBrainsInternals = {
    KB: KB,
    state: state,
    memory: memory,
    normalizeInput: normalizeInput,
    pickResponse: pickResponse,
    generateEntityResponse: generateEntityResponse,
    makeResponse: makeResponse,
    personalizeResponse: personalizeResponse,

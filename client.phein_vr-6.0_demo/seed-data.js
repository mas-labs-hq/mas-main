...
(function() {
    ...
    state.criteria.mustHave = ['sales', 'management', 'leadership', 'communication', 'negotiation'];
    state.criteria.niceToHave = ['marketing', 'b2b', 'crm', 'strategic planning', 'client relationship management'];

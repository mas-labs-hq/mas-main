...
// =====================================================
var SLOT_ADS = [
    { image: 'ad-images/ad1.png', url: 'https://www.pepsodent.com/bd/home.html', alt: 'MortApps Studios', duration: '5s', cta: 'Visit Website', tagline: 'Smile with Confidence' },
    { image: 'ad-images/ad2.png', url: 'https://yellow.co.ke/kartasi-industries-ltd-nairobi', alt: 'Advertisement', duration: '5s', cta: 'Learn More', tagline: 'Africa\'s favourite' },
    { image: 'ad-images/ad3.png', url: 'https://manji.co.ke/', alt: 'Advertisement', duration: '5s', cta: 'Learn More', tagline: 'Bite into happiness' }
];
...
function renderHouseCard(house, idx) {
    ...
    if (house.images && house.images.length > 0) {
        imgHtml = '<img src="' + house.images[0] + '" alt="' + escapeHtml(house.title) + '" loading="lazy" onerror="this.parentElement.innerHTML=getPlaceholderHtml()">';
    } else {
